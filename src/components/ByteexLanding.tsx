      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#" className="text-gray-700 hover:text-black">Reviews</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 space-y-2">
            <a href="#" className="block px-4 py-2 text-gray-700">Shop</a>
            <a href="#" className="block px-4 py-2 text-gray-700">About</a>
            <a href="#" className="block px-4 py-2 text-gray-700">Reviews</a>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <span>Our signature fabric is incredibly comfortable — unlike anything you've ever felt.</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <Button 
                className="bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 rounded-none font-medium"
              >
            ...
            <div className="bg-gray-50 p-4 rounded-lg max-w-sm">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <div className="text-xs text-gray-500">One of 500+ 5 Star Reviews Online</div>
              </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              {/* Main large image */}
              <div className="col-span-2 bg-[#E8D5C4] aspect-[4/3] rounded-lg overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-[#E8D5C4] to-[#D4C2B0] flex items-center justify-center">
              ...
              <div className="bg-gray-100 aspect-square rounded-lg overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                  <div className="text-gray-500 text-sm">Image 1</div>
                </div>
              </div>
              
              <div className="bg-[#E8D5C4] aspect-square rounded-lg overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-[#E8D5C4] to-[#D4C2B0] flex items-center justify-center">
                  <div className="text-gray-500 text-sm">Image 2</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-gray-100 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center items-center space-x-8 lg:space-x-12 opacity-40">
            ...
            <div className="text-lg font-light text-gray-400">Canadian Living</div>
            <div className="text-lg font-light text-gray-400">JILLIAN HARRIS</div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Ethically sourced.</h3>
                  <p className="text-gray-600">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce 
                    lobortis sapien facilisis tincidunt pellentesque. In eget ipsum et felis 
                    finibus consequat.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Responsibly made.</h3>
                  <p className="text-gray-600">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce 
                    lobortis sapien facilisis tincidunt pellentesque. In eget ipsum et felis 
                    finibus consequat.
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Made for living in.</h3>
                  <p className="text-gray-600">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce 
                    lobortis sapien facilitis tincidunt pellentesque. In eget ipsum et felis 
                    finibus consequat.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Unimaginably comfortable.</h3>
                  <p className="text-gray-600">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce 
                    lobortis sapien facilitis tincidunt pellentesque. In eget ipsum et felis 
                    finibus consequat.
          ...
          <div className="relative">
            <div className="relative">
              ...
              {/* Main Product Image */}
              <div className={`aspect-[3/4] rounded-lg overflow-hidden ${images[currentImage].bg}`}>
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-gray-500">Product Image - {images[currentImage].color}</div>
                </div>
              </div>
              ...
              <div className="absolute bottom-4 right-4 flex space-x-2">
                {images.map((image, index) => (
                  <button
                    key={index}
                    className={`w-8 h-8 rounded-full border-2 ${currentImage === index ? 'border-gray-900' : 'border-gray-300'} ${image.bg}`}
            ...
            <div className="mt-4 text-center">
              <span className="text-gray-600">{images[currentImage].color}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Main large image */}
              <div className="row-span-2 bg-[#E8D5C4] rounded-lg overflow-hidden">
                <div className="w-full h-full flex items-center justify-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <p>
                ...
                pellentesque est. Vivamus id orcu congue, faucibus libero nec, placerat ligula.
              </p>
              
              <p>
                Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus 
                mus. Sed eu nisl a metus ultrices sodales.
              </p>
              
              <p>
                Fusce non ante velit. Sed auctor odio eu tempor molestie. Nam mattis, sapien eget 
                lobortis fringilla, eros ipsum tristique tellus, ac convallis urna massa at nibh.
              </p>
              
              <p>
                Duis non fermentum augue. Vivamus laoreet aliquam risus, sed euismod leo aliquam 
                ut. Vivamus in felis eu lacus laoreet aliquam nec ut sapien.
              </p>
        ...
        <div className="border border-blue-200 rounded-lg p-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">You enjoy!</h3>
              <p className="text-gray-600">
          ...
          <div className="text-center">
            <div className="flex justify-center items-center space-x-1 text-yellow-400 mb-2">
              ...
              <span className="text-sm text-gray-600 ml-2">Over 500+ 5 Star Reviews Online</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce lobortis sapien 
            facilisis tincidunt pellentesque. In eget ipsum et felis finibus consequat. Fusce non 
            nibh luctus.
          </p>
        </div>
        
        {/* Image Gallery */}
        <div className="grid grid-cols-6 lg:grid-cols-12 gap-2 mb-12">
    ...
    <div className="bg-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
              ...
              {faqs.map((faq, index) => (
                <div key={index} className="border-b border-gray-200">
                  ...
                  >
                    ...
                    <Plus className={`w-5 h-5 text-gray-400 transition-transform ${openFaq === index ? 'rotate-45' : ''}`} />
                  </button>
                  {openFaq === index && (
                    <div className="pb-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="bg-[#E8D5C4] aspect-[3/4] rounded-lg"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              <div className="text-4xl font-light text-gray-900 mb-2">3,927 kg</div>
              <div className="text-gray-600">of CO2 saved</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-light text-gray-900 mb-2">2,546,187 days</div>
              <div className="text-gray-600">of drinking water saved</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-light text-gray-900 mb-2">7,321 kWh</div>
          ...
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce lobortis sapien 
            facililis tincidunt pellentesque. In eget ipsum et felis finibus consequat.
          </p>
          ...
          <Button 
            className="bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 rounded-none font-medium mb-8"
          >
            Customize Your Outfit
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
          ...
          <div className="grid md:grid-cols-3 gap-8 pt-8 border-t border-gray-200">
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-sm text-gray-600">Over 500+ 5 Star Reviews Online</span>
            </div>
            <div className="flex items-center justify-center space-x-3">
              <Truck className="w-5 h-5 text-gray-500" />
              <span className="text-sm text-gray-600">Made ethically and responsibly</span>
            </div>
          </div>
        </div>
      </div>
